  ...
  <div class="wrapper fixed-left">
    ...
    <div class="row">
      <div class="col-sm-6 ol-xs-8">
            ...
            <h5 style="color:orange"><label for="name">Nom Catégorie</label></h5>
    ...
    <div class="form-group">
            ...
            <a href="<?php echo base_url().'control/index';?>" class="btn-secondary btn" style="width:100px">Annuler &ensp;&ensp;</a>
        </div>
</div>
</div>
