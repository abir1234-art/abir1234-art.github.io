    ...
    <div class="col-lg-8 col-lg-offset-2">
      ...
      <form action="<?php echo base_url()?>auto/contact" method="POST" id="form">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="subject" name="subject" placeholder="Entrer sujet ">
        </div>  
        ...
        <div class="form-group">
            ...
            <a href="<?php echo base_url('pdf_control/index')?>" target="_blank" class="btn btn-primary"> Afficher PDF</a><br />
