  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo base_url('userpage1');?>"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">User Page
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('adminpage');?>"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">User Admin</font></font></a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-lg-8 col-lg-offset-2">
      ...
      <form action="<?php echo base_url()?>auto/contact" method="POST" id="form">
        ...
        <div class="form-group">
            ...
            <button class="btn btn-primary"  type="submit" ><a href="<?php echo base_url('pdf_control/index')?>">télécharger</a></button></form>
