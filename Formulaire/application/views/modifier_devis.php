            ...
            <form action="<?php echo base_url();?>control/edit_devis/<?php echo $single_devis->num_devis;?>" method="POST">
                ...
                <div class="form-group">
                   <label for="date_creation">date création</label>
                    <input type="date" class="form-control"  name="date_creation" value="<?php echo $single_devis->date;?>"  placeholder="Enter date création devis ">
                    <?php echo form_error('date_creation');?>
                </div>
                <div class="form-group">
                   <label for="validite">Durée validité</label>
                    <input type="numeric" class="form-control" value="<?php echo $single_devis->duree;?>"  name="validite"  placeholder="Enter validité de devis">
