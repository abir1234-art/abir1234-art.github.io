...
<div class="wrapper fixed-left">
    ...
    <div class="text-right">
       ...
       <div class="text-right">
          ...
          <a href="<?php echo base_url().'control/create_devis';?>"class="btn btn-info" ><i class="fa fa-plus" aria-hidden="true"></i>Nouvelle devis</a>
    ...
    <?php $no=1; 
                   ...
                   <tr>
                       ...
                       <td><?php echo $dev->ref_client ?></td>
                       <td><?php echo $dev->nom ?></td>
                       <td><?php echo $dev->prenom ?></td>
                       <td><?php echo $dev->nom_produit ?></td>
