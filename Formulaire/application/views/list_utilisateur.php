...
<div class="wrapper fixed-left">
  ...
  <div class="row">
        <div class="text-right">
          <div class="col-lg-12"><center><h1> Liste Utilisateurs</h1></center></div></div>
          <br /> 
</div>    
<br />
 <hr>
  <br />
    ...
    <div class="text-right">
       ...
       <div class="text-right">
          ...
          <a href="<?php echo base_url().'auto/register';?>"class="btn btn-info" ><i class="fa fa-plus" aria-hidden="true"></i>Nouveau utilisateur</a>
                   ...
                   <tr>
                       ...
                       <td><?php echo $con->phone ?></td>
                        ...
                        $status=$con->status;
                           if($status == 1){
                             ?>
                                  <a href="<?php echo base_url();?>auto/update_status_utilisateur/<?php echo $con->user_id;?>/<?php echo $con->status; ?>" class="btn btn-success">Active</a>
                             <?php
                              }
                              else{
                                ?>
                                   <a href="<?php echo base_url();?>auto/update_status_utilisateur/<?php echo $con->user_id;?>/<?php echo $con->status;?>" class="btn btn-danger">Inactive</a>
                              <?php
                              }
                              ?>     
                             <a href="<?php echo base_url();?>auto/edit_utilisateur/<?php echo $con->user_id;?>" class="btn btn-primary" style="width:115px"><i class="fa fa-pencil fa-fw"></i>Modifier</a>
