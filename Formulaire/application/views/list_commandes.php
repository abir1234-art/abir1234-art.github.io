    ...
    <br />
     ...
     <div class="row">
        <div class="text-right">
          <div class="col-lg-12"><center><h1> Liste Commandes</h1></center></div></div>
          <br /> 
</div>    
<br />
 <hr>
  <br />
       ...
       <div class="text-right">
          ...
          <a href="<?php echo base_url().'control/ajouter_commande';?>"class="btn btn-info" ><i class="fa fa-plus" aria-hidden="true"></i>Nouvelle commande</a>
    ...
    <?php $i=1;
                if(isset($commandes)) {
                   ...
                   <tr>
                     ...
                     <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $commande->total_commande;?></td>
                     <td>
                            
                             <a href="<?php echo base_url();?>control/modifier_commande/<?php echo $commande->numero_commande;?>" class="btn btn-primary" style="width:120px"><i class="fa fa-pencil fa-fw"></i>Modifier</a>
                        </td>
