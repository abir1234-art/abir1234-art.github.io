...
<div class="wrapper fixed-left">
    ...
    <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?php echo base_url();?>auto/view_utilisateur">Utilisateurs</a></li>
    <li class="breadcrumb-item active" aria-current="page">Ajouter Nouveau utilisateur</li>
  </ol>
</nav>
</br>
  ...
  <form action="<?php echo base_url().'auto/register';?>" method="POST">
    ...
    <label  for="status">Etat :</label>
        ...
        <div class="form-group">
            <button class="btn btn-primary"  name="register" style="width:100px">Ajouter</button>&ensp;&ensp;&ensp;&ensp;
