...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="container" style="margin-top:20px";>
        <h1> Admin Form </h1>
        <?php echo form_open('home_crud/edit');?>
        <div class="row">
            <div class="col-lg-6">

                <div class="form-group">
                    <label for="Nom">Nom</label>
                    <?php echo form_input(['class'=>'form-control', 'placeholder'=>'Enter nom','name'=>'nom']);?>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <?php echo form_input(['class'=>'form-control', 'placeholder'=>'Enter Prenom','name'=>'prenom']);?>
                </div>
