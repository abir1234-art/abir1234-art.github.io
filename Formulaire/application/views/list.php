...
<div class="wrapper fixed-left">
    ...
    <br />
       ...
       <div class="text-right">
          <a href="<?php echo base_url().'auto/create';?>"class="btn btn-primary pull-right" style="width:200px"><i class="fa fa-user fa-fw"></i>Nouvelle Client</a>
        </div>
        </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-striped">
                      ...
                      <tr style="background-color:#1C1C1C">
                          ...
                          <th style="color:white" with="60">Action</th>
                   ...
                   <tr>
                     ...
                     <td>
                         <?php
                           ...
                           if($status == 1){
                             ?>
                                  <a href="<?php echo base_url();?>auto/update_status/<?php echo $client->id;?>/<?php echo $client->status; ?>" class="btn btn-success">Active</a>
                             <?php
                              }
                              else{
                                ?>
                                   <a href="<?php echo base_url();?>auto/update_status/<?php echo $client->id;?>/<?php echo $client->status;?>" class="btn btn-danger">InActive</a>
                              <?php
                              }
                              ?>     
                             <a href="<?php echo base_url();?>auto/edit_test/<?php echo $client->id;?>" class="btn btn-primary" style="width:120px"><i class="fa fa-pencil fa-fw"></i>Modifier</a>
                        </td>
